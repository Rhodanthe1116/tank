<template>
  <div
    id="bullet1"
    v-bind:style="{
      marginLeft: this.bullet.x + 'px',
      marginTop: this.bullet.y + 'px',
      transform: 'rotate(' + this.bullet.deg + 'deg)',
      width: this.bullet.width + 'px',
      height: this.bullet.height + 'px',
      backgroundColor: this.bullet.color,
      zIndex: this.bullet.zIndex,
    }"
