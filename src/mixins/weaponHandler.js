  ...
  methods: {
    weaponPrepare: function () {
      ...
      if (type == 1) {
        ...
        this.bullet.x =
          this.tank.tank.x + this.tank.tank.width / 2 - this.bullet.width / 2
        this.bullet.y =
          this.tank.tank.y + this.tank.tank.height / 2 - this.bullet.height / 2
      } else if (type == 2) {
        this.bullet.zIndex = 1
    ...
    weaponFly: function (X, Y) {
      if (this.bullet.type != 3) {
        ...
        let d = Math.sqrt(
          Math.pow(bullet_centerX - centerX, 2) +
            Math.pow(bullet_centerY - centerY, 2)
        )
    ...
    mineExplode: function () {
      ...
      this.mineTimeout1 = setTimeout(
        this.explodeAnim,
        this.bullet.mineExplodeTime * 1000
      )
    },
